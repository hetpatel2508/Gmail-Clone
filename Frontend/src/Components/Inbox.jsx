...
export default function Inbox() {
  ...
  return (
    <div className=" w-[calc(100vw-75.5px)] h-full flex flex-col ml-[76px] relative">
      <div className='w-full h-[93px] sticky top-[61px] left-0'>
        ...
        <div className="w-full h-[45px] flex bg-green-100">
          {data.map((element, index) => {
            return (
              <div
                key={index}
                className="h-full w-[200px] cursor-pointer flex items-center bg-gray-100 hover:bg-gray-200"
