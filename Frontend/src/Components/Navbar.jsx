...
export default function Navbar() {
  return (
    <div className="w-full h-[61px] flex items-center justify-center bg-red-100">
      <div className="w-[98.5%] h-[47px] flex">
        <div className="h-full w-[15.5%] flex items-center">
          <div className="w-[47px] h-[47px] flex justify-center items-center rounded-full hover:bg-gray-100 ">
        ...
        <div className="h-full w-[12.5%]  flex items-center">
          <div className="w-[44px] h-[44px] flex items-center justify-center  hover:bg-gray-100 rounded-full ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24px"
              height="24px"
          ...
          <div className="w-[48px] h-[48px] flex items-center justify-center  hover:bg-gray-100 rounded-full ">
          ...
          <div className="w-[48px] h-[48px] flex items-center justify-center ">
            <div className="w-[34px] h-[34px] flex items-center justify-center bg-blue-200 rounded-full hover:bg-gray-100 rounded-full "></div>
          </div>
        </div>
      </div>
    </div>
